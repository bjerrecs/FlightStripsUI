...
export const Strip = (props) => {
  return (
    <div className="w-fit h-16 bg-[#BEF5EF] border-4 flex items-center font-bold ">
        <div className="border-r-2 border-l-4 border-t-4 border-b-4 border-[#85B4AF] w-36 pr-8 h-full flex items-center pl-2 text-xl">
            {props.callsign}
        </div>
        ...
        <div className="border-r-2 border-l-2 border-t-4 border-b-4 border-[#85B4AF] w-32 h-full flex flex-col">
