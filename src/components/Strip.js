...
export const Strip = (props) => {
  return (
    <div className="w-fit h-16 bg-[#BEF5EF] border-l-4 border-r-4 border-t-2 border-b-2 mb-1 flex items-center">
        ...
        <div className="border-r-1 border-l-1 border-t-2 border-b-2 border-[#85B4AF] w-32 h-full flex items-top justify-between text-center pl-2 pr-2">
